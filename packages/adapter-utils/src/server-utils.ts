...
export function renderPaperclipWakePrompt(
  ...
  if (artifactInventory) {
    ...
    lines.push(
      "Use approved task workspace helper commands such as `task_workspace.py read`, `task_workspace.py search`, and `task_workspace.py extract-pdf` for workspace files; do not try plain `cat`, shell `grep`, `sed`, `ls`, or shell redirection when the task workspace is under command policy.",
    );
    lines.push(
